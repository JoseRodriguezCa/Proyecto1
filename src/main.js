...
function viewfilters() {
  ...
  const filtersContent = `
    ...
    <select name="sellers" id="sellers">
        ...
        <option value="pccomponentes">ASUS</option>
  ...
  <article class="price-container">
    ...
    <input type="number" id="price-input" name="price-input"  step="0.01" placeholder="1">
    <br>
    <label for="price-filter"></label>
    <input class="price-slider" type="range" id="price-filter" name="price-filter" value="1" min="1" max="1500">
  </article>
  <article class="btns-filters">
    <button class="seacher" id="seacher">
        Buscar
    </button>
    <button class="cleaner" id="cleaner">
        limpiar filtros
    </button>
  </article>
  `;

  filters.innerHTML += filtersContent;
}
...
const productList = [
  {
    ...
    image:
      "https://thumb.pccomponentes.com/w-300-300/articles/1063/10636779/1426-pccom-revolt-3060-intel-core-i7-12700h-32gb-500gb-ssd-rtx-3060-156-foto.jpg",
  },
...

  {
    ...
    seller: "lenovo",
    image:
      "https://thumb.pccomponentes.com/w-300-300/articles/1063/10633201/1361-lenovo-v15-igl-intel-celeron-n4020-8gb-256-gb-ssd-156.jpg",
  },

  {
    ...
    seller: "hp",
    image:
      "https://thumb.pccomponentes.com/w-300-300/articles/1042/10428549/1392-hp-15s-fq5013ns-intel-core-i5-1235u-8gb-512gb-ssd-156.jpg",
  },

  {
    ...
    seller: "lenovo",
    image:
      "https://thumb.pccomponentes.com/w-300-300/articles/1067/10672816/1753-lenovo-ideapad-1-15ada7-amd-ryzen-3-3250u-8gb-256gb-ssd-156.jpg",
  },

  {
    ...
    seller: "asus",
    image:
      "https://thumb.pccomponentes.com/w-300-300/articles/1066/10665058/1694-asus-vivobook-15-f515ja-ej4134-intel-core-i7-1065g7-8gb-512gb-ssd-156.jpg",
  },

  {
    ...
    seller: "pccomponentes",
    image:
      "https://thumb.pccomponentes.com/w-300-300/articles/1040/10401732/1676-medion-akoya-e15415-intel-core-i5-10210u-8gb-256gb-ssd-156.jpg",
  },

  {
    ...
    seller: "hp",
    image:
      "https://thumb.pccomponentes.com/w-300-300/articles/1039/10396660/1123-hp-victus-16-e0101ns-amd-ryzen-7-5800h-32gb-512gb-ssd-rtx-3060-161.jpg",
  },

  {
    ...
    seller: "pccomponentes",
    image:
      "https://thumb.pccomponentes.com/w-300-300/articles/1001/10011004/1466-msi-katana-gf66-12ud-082xes-intel-core-i7-12700h-16gb-1tb-ssd-rtx3050-156-3b7c3f62-ac49-4155-bcd2-35f217618c49.jpg",
  },
...
function viewproducts(productsparam) {
  products.innerHTML = "";
  ...
  if (productsparam != "") {
    ...
    products.innerHTML = `<h1>No se encuentran productos con estas caracteristicas</h1>`;
  }
}
...
sellers.addEventListener("change", () => {
  ...
  const filterProducts = value
    ? productList.filter((product) => product.seller == value)
    : productList;
...
search.addEventListener("click", () => {
  ...
  let filterProducts;
  if (sellersValue) {
    filterProducts = productList.filter(
      (product) => product.price <= priceValue && product.seller == sellersValue
    );
  } else {
    filterProducts = productList.filter(
